...
| `pet_name` | 桌宠 | 桌宠名字 |
| `persona_source` | `custom` | 人格来源：插件自定义人格 / AstrBot 已配置人格 / AstrBot 默认人格。选用 AstrBot 人格后，`persona` 自定义项与桌宠语境包装都会被忽略，完全按所选人格（含其开场对话）对话 |
| `astrbot_persona_id` | 空 | 选择 AstrBot WebUI 里已配置的人格（人格来源选「AstrBot 已配置人格」时生效） |
| `persona` | 内置 | 插件自定义人格（仅人格来源选「插件自定义人格」时生效，其余情况被忽略） |
